...
$categories_array 		= $categories->get(array('shared_user_id' => $auth->get('id'), 'id' => $cat_id, 'limit' => 1, 'get_other_data' => true, 'global' => 0));
	...
	<form method="post" action="<?php echo safe_output($_SERVER['REQUEST_URI']); ?>">
		...
		<div class="col-md-3">
			<div class="well well-sm">
				<div class="pull-left">
					<h4><?php echo $language->get('Add Shared Password'); ?></h4>
				</div>
				...
				<p><?php echo $language->get('This page allows you to add a new password in to the shared category.'); ?></p>
				<br />
