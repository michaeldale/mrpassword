...
<div class="row">
	...
	<div class="col-md-3">
		...
		<div class="well well-sm">
			<form method="get" action="<?php echo safe_output($_SERVER['REQUEST_URI']); ?>">
				...
				<div class="pull-right">
					...
					<a href="<?php echo safe_output($config->get('address')); ?>/passwords/global/" class="btn btn-default"><?php echo $language->get('Clear'); ?></a>
				</div>
				<div class="clearfix"></div>
			</form>
		</div>
		...
		<?php if ($access_level == 2) { ?>
			<div class="well well-sm">
				<form method="post" action="<?php echo safe_output($config->get('address')); ?>/passwords/addglobal/<?php if ($id != 0) echo (int) $id . '/'; ?>" class="form-inline" role="form">
	...
	<div class="col-md-9">
		...
		<p>
		<?php if ($access_level == 2) { ?>
			<a href="<?php echo $config->get('address'); ?>/passwords/addglobal/<?php if ($id != 0) echo (int) $id . '/'; ?>" class="btn btn-default btn-sm"><?php echo $language->get('Add'); ?></a>
		<?php } ?>
		<?php if ($id != 0) { ?>
			<?php if ($show_all) { ?>
				<a href="<?php echo $config->get('address'); ?>/passwords/global/<?php echo (int) $id; ?>/" class="btn btn-default btn-sm"><?php echo $language->get('Hide Passwords'); ?></a>
			<?php } else { ?>
				<a href="<?php echo $config->get('address'); ?>/passwords/global/<?php echo (int) $id; ?>/?action=show_all" class="btn btn-default btn-sm"><?php echo $language->get('Show Passwords'); ?></a>
			<?php } ?>
		<?php } else { ?>
			<?php if ($show_all) { ?>
				<a href="<?php echo $config->get('address'); ?>/passwords/global/" class="btn btn-default btn-sm"><?php echo $language->get('Hide Passwords'); ?></a>
			<?php } else { ?>
				<a href="<?php echo $config->get('address'); ?>/passwords/global/?action=show_all" class="btn btn-default btn-sm"><?php echo $language->get('Show Passwords'); ?></a>
			<?php } ?>
		<?php } ?>
		</p>
