		...
		<div class="table-responsive">		
			<table class="table table-striped">
				...
				<tr <?php if ($i % 2 == 0 ) { echo 'class="switch-1"'; } else { echo 'class="switch-2"'; }; ?>>
					...
					<td class="centre" name="password<?php echo (int) $password['id']; ?>"><?php if ($show_all) { ?><?php echo safe_output($encryption->decrypt($password['password'])); ?><?php } else { ?><a href="#password<?php echo (int) $password['id']; ?>" class="show_share_password" id="id-<?php echo (int) $password['id']; ?>"><?php echo $language->get('Show'); ?></a><?php } ?></td>
				</tr>
				<?php $i++; } ?>
			</table>
		</div>
